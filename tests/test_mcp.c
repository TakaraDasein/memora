...
TEST(mcp_initialize_response) {
    ...
    ASSERT_NOT_NULL(json);
    ASSERT_NOT_NULL(strstr(json, "memora"));
...
TEST(server_handle_initialize) {
    ...
    ASSERT_NOT_NULL(strstr(resp, "memora"));
...
TEST(analysis_profile_arguments_fail_closed_and_disable_http) {
    ...
    const char *no_profile[] = {"memora"};
    const char *analysis_equals[] = {"memora", "--tool-profile=analysis"};
    const char *analysis_pair[] = {"memora", "--tool-profile", "analysis"};
    const char *scout_equals[] = {"memora", "--tool-profile=scout"};
    const char *unknown_equals[] = {"memora", "--tool-profile=analaysis"};
    const char *unknown_pair[] = {"memora", "--tool-profile", "all"};
    const char *missing_value[] = {"memora", "--tool-profile"};
...
/* #1025: agents pass the repo FOLDER name ("memora"), but

...
The binary is output to `build/c/memora-mcp`.
...
Check [issues labeled `good first issue`](https://github.com/TakaraDasein/memora/labels/good%20first%20issue) for beginner-friendly tasks with clear scope and guidance.

...
<p align="center">
  <img src="docs/graph-ui-screenshot.png" alt="Memora graph visualization" width="800">
  <br>
  <em>Memora — black & white graph visualization, fork of codebase-memory-mcp</em>
</p>

**Memora** is a fork of [codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) with a custom black & white UI theme.

This project retains all the power of the original codebase-memory-mcp — full-indexing of repositories in milliseconds, a persistent knowledge graph of functions, classes, call chains, HTTP routes, and 15 MCP tools — while providing a distinctive monochrome visual experience.

> See the original project's [README](https://github.com/DeusData/codebase-memory-mcp) for the full feature set, benchmarks, and documentation.

class CodebaseMemoryMcp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/TakaraDasein/memora/releases/download/v#{version}/memora-darwin-arm64.tar.gz"
      sha256 "fbd047509852021b5446a11141bcb0a3d1dcaebf6e5112460960f29f052c1c58"
    end
    on_intel do
      url "https://github.com/TakaraDasein/memora/releases/download/v#{version}/memora-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/TakaraDasein/memora/releases/download/v#{version}/memora-linux-arm64.tar.gz"
      sha256 "d2f842d1365da5c35d9c5796f57a821c9745267350994346735e1e6e04d46091"
    end
    on_intel do
      url "https://github.com/TakaraDasein/memora/releases/download/v#{version}/memora-linux-amd64.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      To tap this formula directly:
        brew tap deusdata/memora https://github.com/TakaraDasein/memora
        brew install memora
    EOS
  end

  test do
    assert_match "memora", shell_output("#{bin}/memora --version")
  end
end
